        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "record_parsing",
                    "RecordParsing",
                    "RecordParsing_ConstraintAndSemiColon",
                    2,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "record_parsing",
                    "RecordParsing",
                    "RecordParsing_ConstraintAndSemiColon_MissingColon",
                    3,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "record_parsing",
                    "RecordParsing",
                    "RecordParsing_TwoConstraintsAndSemiColon",
                    4,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "record_parsing",
                    "RecordParsing",
                    "RecordParsing_ConstraintAndSemiColon_Class",
                    5,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "record_parsing",
                    "RecordParsing",
                    "RecordParsing_TwoConstraintsAndSemiColon_Class",
                    6,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "record_parsing",
                    "RecordParsing",
                    "AbstractMethod_ConstraintsAndSemiColon",
                    7,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "record_parsing",
                    "RecordParsing",
                    "TestClassWithMultipleConstraints001",
                    8,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "record_parsing",
                    "RecordParsing",
                    "TestClassWithMultipleConstraints002",
                    9,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "record_parsing",
                    "RecordParsing",
                    "RecordParsing_ConstraintsAndCurlyBraces",
                    10,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "record_parsing",
                    "RecordParsing",
                    "RecordParsing_ConstraintAndCommaAndSemiColon",
                    11,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "record_parsing",
                    "RecordParsing",
                    "RecordParsing_ConstraintAndCommaAndNewAndSemiColon",
                    12,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
