        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "RequiredModifierIncompleteProperty_01",
                    44,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "RequiredModifierIncompleteProperty_02",
                    45,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "RequiredModifierIncompleteMember_01",
                    46,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "RequiredModifierIncompleteMember_02",
                    47,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "RequiredModifierIncompleteMember_03",
                    48,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "RequiredModifierIncompleteMember_04",
                    49,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "RequiredModifierIncompleteMember_05",
                    50,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "RequiredModifier_LocalNamedRequired_TopLevelStatements",
                    51,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_06",
                    52,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_07",
                    53,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_08",
                    54,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_09",
                    55,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_10",
                    56,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_16",
                    57,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_17",
                    58,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_18",
                    59,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_19",
                    60,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_20",
                    61,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_21",
                    62,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_22",
                    63,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_28",
                    64,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_29",
                    65,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_30",
                    66,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_31",
                    67,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_32",
                    68,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_38",
                    69,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_39",
                    70,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_40",
                    71,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_41",
                    72,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_42",
                    73,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_43",
                    74,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_44",
                    75,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_45",
                    76,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_46",
                    77,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "OperatorDeclaration_ExplicitImplementation_47",
                    78,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_03",
                    79,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_06",
                    80,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_07",
                    81,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_08",
                    82,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_09",
                    83,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_10",
                    84,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_16",
                    85,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_17",
                    86,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_18",
                    87,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_19",
                    88,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_20",
                    89,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_21",
                    90,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_22",
                    91,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_23",
                    92,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_24",
                    93,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_25",
                    94,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_26",
                    95,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_27",
                    96,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_28",
                    97,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_29",
                    98,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_30",
                    99,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_31",
                    100,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_32",
                    101,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_33",
                    102,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_34",
                    103,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "ConversionDeclaration_ExplicitImplementation_35",
                    104,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "UncheckedOperatorDeclaration_01",
                    117,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "UncheckedOperatorDeclaration_04",
                    118,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_01",
                    123,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_02",
                    124,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_03",
                    125,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_04",
                    126,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_05",
                    127,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_06",
                    128,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_07",
                    129,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_08",
                    130,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_09",
                    131,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_10",
                    132,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_11",
                    133,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_12",
                    134,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_13",
                    135,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_14",
                    136,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_15",
                    137,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_16",
                    138,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_17",
                    139,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_18",
                    140,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_19_Partial",
                    141,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "CompoundAssignmentDeclaration_20_Partial",
                    142,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "IncrementDeclaration_01_Partial",
                    143,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "member_declaration_parsing_tests",
                    "MemberDeclarationParsingTests",
                    "IncrementDeclaration_02_Partial",
                    144,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
