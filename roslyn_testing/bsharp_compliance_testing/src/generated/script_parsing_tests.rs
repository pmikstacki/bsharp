        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    ...
                    "ScriptParsingTests",
                    "MethodDeclarationAndMethodCall",
                    1,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "NewAnonymousTypeExpressionStatement",
                    5,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "NewArrayExpressionWithInitializerAndPostFixExpressionStatement",
                    7,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "NewModifier_Method_ReturnsIdentifier",
                    9,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "NewModifier_Method_ReturnsArray",
                    10,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "NewModifier_Method_ReturnsPartialArray",
                    11,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "NewModifier_PartialMethod_ReturnsPredefined",
                    12,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "NewModifier_Method_ReturnsPrimitive",
                    13,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "NewModifier_Indexer_ReturnsIdentifier",
                    14,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "NewModifier_Indexer_ReturnsArray",
                    15,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "Multiplication_Interactive_Semicolon",
                    37,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "Multiplication_Interactive_NoSemicolon",
                    38,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "Ternary_MethodDecl_GenericAmbiguity1",
                    74,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "Ternary_Expression_GenericAmbiguity1",
                    127,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "GlobalStatementSeparators_Comma1",
                    151,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "GlobalStatementSeparators_Comma2",
                    152,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "GlobalStatementSeparators_ClosingParen",
                    153,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "GlobalStatementSeparators_ClosingBracket",
                    154,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "script_parsing_tests",
                    "ScriptParsingTests",
                    "GlobalStatementSeparators_ClosingBrace",
                    155,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
