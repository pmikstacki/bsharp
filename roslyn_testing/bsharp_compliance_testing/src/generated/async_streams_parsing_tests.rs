        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "async_streams_parsing_tests",
                    "AsyncStreamsParsingTests",
        ...
        match r {
            Ok((_rest, unit)) => {
                after_parse::after_parse_with_expected(
                    "async_streams_parsing_tests",
                    "AsyncStreamsParsingTests",
                    "AwaitUsingWithExpression_Reversed",
                    3,
                    Some(expected.clone()),
                    CaseData::File {
                        unit: &unit,
