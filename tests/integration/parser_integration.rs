// Parser integration tests for the B# parser
// Tests that verify complete parser functionality across different C# language features

use bsharp::parsers::csharp::parse_csharp_source;
