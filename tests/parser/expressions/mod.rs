// mod anonymous_method_expression_tests; // File doesn't exist yet
...
// mod cast_expression_tests; // File doesn't exist yet
...
// mod parenthesized_expression_tests; // File doesn't exist yet
mod pattern_matching_tests; // Renamed from pattern_expression_tests
mod pattern_tests;
// mod postfix_unary_expression_tests; // File doesn't exist yet
