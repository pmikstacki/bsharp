...
fn test_parse_for_statement_logic() {
    ...
    use bsharp::parser::expressions::statements::for_statement_parser::parse_for_statement;
    ...
    assert!(
        remaining_multiple_init.is_empty(),
        "Input not fully consumed: {}",
        remaining_multiple_init
    );
    ...
    assert!(
        remaining_multiple_iter.is_empty(),
        "Input not fully consumed: {}",
        remaining_multiple_iter
    );
