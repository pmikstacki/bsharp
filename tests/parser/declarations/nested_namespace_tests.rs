...
use bsharp::syntax::ast::TopLevelDeclaration;
use bsharp::syntax::nodes::declarations::NamespaceBodyDeclaration;
...
"#;
    ...
    match &cu.declarations[0] {
        TopLevelDeclaration::Namespace(outer) => {
            ...
            let has_class = outer.declarations.iter().any(|d| matches!(d, NamespaceBodyDeclaration::Class(_)));
            let has_namespace = outer.declarations.iter().any(|d| matches!(d, NamespaceBodyDeclaration::Namespace(_)));
