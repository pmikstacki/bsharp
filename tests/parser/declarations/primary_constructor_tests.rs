use bsharp::parser::expressions::declarations::type_declaration_parser::{parse_class_declaration, parse_struct_declaration};
use bsharp::syntax::nodes::declarations::{ClassDeclaration, StructDeclaration};
