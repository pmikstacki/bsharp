...
use bsharp::syntax::nodes::declarations::{NamespaceDeclaration, FileScopedNamespaceDeclaration};

// Assuming syntax functions like parse_file_scoped_namespace and parse_namespace_declaration exist
// use bsharp::syntax::syntax::{parse_file_scoped_namespace, parse_namespace_declaration};
