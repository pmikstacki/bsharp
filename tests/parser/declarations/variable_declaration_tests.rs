use bsharp::parser::expressions::declarations::variable_declaration_parser::{
...
fn test_parse_local_variable_declaration_single_declarator() {
    ...
    assert_eq!(
        ...
        Type::Primitive(bsharp::syntax::nodes::types::PrimitiveType::Int)
    );
...
fn test_parse_local_variable_declaration_multiple_declarators() {
    ...
    assert_eq!(
        decl.declaration_type,
        Type::Primitive(bsharp::syntax::nodes::types::PrimitiveType::String)
    );
