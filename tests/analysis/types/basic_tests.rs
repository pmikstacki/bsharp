    ...
    let class = ClassDeclaration {
        ...
        body_declarations: vec![
            ClassBodyDeclaration::Field(FieldDeclaration {
                modifiers: Vec::new(),
                ty: Type::Reference(create_test_identifier("string")),
...
fn test_analyze_generic_types() {
    ...
    let generic_class = ClassDeclaration {
        ...
        body_declarations: vec![
            ClassBodyDeclaration::Field(FieldDeclaration {
                modifiers: Vec::new(),
                ty: Type::Reference(create_test_identifier("T")),
...
fn test_inheritance_analysis() {
    ...
    let further_derived = ClassDeclaration {
        ...
        type_parameters: None,
        base_types: vec![
            Type::Reference(create_test_identifier("DerivedClass")),
        ],
        body_declarations: Vec::new(),
    };
...
fn test_interface_analysis() {
    ...
    assert!(metrics.implemented_interfaces.contains(&"IComparable".to_string()));
    assert!(metrics.implemented_interfaces.contains(&"IDisposable".to_string()));
    assert!(metrics.implemented_interfaces.contains(&"ICloneable".to_string()));
}
...
fn test_type_usage_analysis() {
    ...
    let class_with_various_types = ClassDeclaration {
        ...
        body_declarations: vec![
            ClassBodyDeclaration::Field(FieldDeclaration {
                modifiers: Vec::new(),
                ty: Type::Array { element_type: Box::new(Type::Reference(create_test_identifier("string"))), rank: 1 },
            ...
            ClassBodyDeclaration::Method(MethodDeclaration {
                ...
                return_type: Type::Generic {
                    ...
                    args: vec![
                        ...
                        Type::Generic {
                            base: create_test_identifier("List"),
                            args: vec![Type::Nullable(Box::new(Type::Reference(create_test_identifier("T"))))],
                        },
                    ],
                },
...
fn test_circular_dependency_detection() {
    ...
    let class_a = ClassDeclaration {
        ...
        body_declarations: vec![
            ClassBodyDeclaration::Field(FieldDeclaration {
                modifiers: Vec::new(),
                ty: Type::Reference(create_test_identifier("ClassB")),
    ...
    let class_b = ClassDeclaration {
        ...
        body_declarations: vec![
            ClassBodyDeclaration::Field(FieldDeclaration {
                modifiers: Vec::new(),
                ty: Type::Reference(create_test_identifier("ClassA")),
...
fn test_comprehensive_type_analysis() {
    ...
    let comprehensive_class = ClassDeclaration {
        ...
        body_declarations: vec![
            ClassBodyDeclaration::Field(FieldDeclaration {
                modifiers: Vec::new(),
                ty: Type::Array { element_type: Box::new(Type::Reference(create_test_identifier("T"))), rank: 1 },
