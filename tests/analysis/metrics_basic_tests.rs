// Migrated from src/analysis/metrics/tests/basic_tests.rs
// Adjusted imports to use crate:: paths since this is an external tests crate.

use crate::analysis::metrics::basic::*;
...
fn test_collect_from_statement() {
    ...
    let if_stmt = Statement::If(IfStatement {
        ...
        consequence: Box::new(Statement::Block(vec![Statement::For(ForStatement {
            initializer: None,
            condition: None,
            iterator: None,
        ...
        Statement::Switch(SwitchStatement {
            ...
            sections: vec![SwitchSection {
                labels: vec![SwitchLabel::Case(
                    crate::parser::nodes::expressions::expression::Expression::Literal(
                        crate::parser::nodes::literals::Literal::Integer(1),
                    ),
                )],
