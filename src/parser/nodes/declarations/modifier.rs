...
impl Modifier {
    ...
    pub fn get_info(&self) -> ModifierInfo {
        match self {
            ...
            Modifier::Public => ModifierInfo { category: ModifierCategory::Access, order: 1 },
            Modifier::Private => ModifierInfo { category: ModifierCategory::Access, order: 1 },
            Modifier::Protected => ModifierInfo { category: ModifierCategory::Access, order: 1 },
            Modifier::Internal => ModifierInfo { category: ModifierCategory::Access, order: 1 },
            
            // Static modifier (should be second)
            Modifier::Static => ModifierInfo { category: ModifierCategory::StaticInstance, order: 2 },
            
            // Inheritance modifiers (should be third)
            Modifier::Abstract => ModifierInfo { category: ModifierCategory::Inheritance, order: 3 },
            Modifier::Sealed => ModifierInfo { category: ModifierCategory::Inheritance, order: 3 },
            Modifier::Virtual => ModifierInfo { category: ModifierCategory::Inheritance, order: 3 },
            Modifier::Override => ModifierInfo { category: ModifierCategory::Inheritance, order: 3 },
            
            // State modifiers (should be fourth)
            Modifier::Readonly => ModifierInfo { category: ModifierCategory::State, order: 4 },
            Modifier::Volatile => ModifierInfo { category: ModifierCategory::State, order: 4 },
            Modifier::Const => ModifierInfo { category: ModifierCategory::State, order: 4 },
            
            // Special modifiers (can come after state modifiers)
            Modifier::Unsafe => ModifierInfo { category: ModifierCategory::Special, order: 5 },
            Modifier::Extern => ModifierInfo { category: ModifierCategory::Special, order: 5 },
            Modifier::New => ModifierInfo { category: ModifierCategory::Special, order: 5 },
            Modifier::Partial => ModifierInfo { category: ModifierCategory::Special, order: 5 },
            Modifier::Async => ModifierInfo { category: ModifierCategory::Special, order: 5 },
            
            // Parameter modifiers (usually in parameter lists)
            Modifier::Ref => ModifierInfo { category: ModifierCategory::Parameter, order: 6 },
            Modifier::Out => ModifierInfo { category: ModifierCategory::Parameter, order: 6 },
            Modifier::In => ModifierInfo { category: ModifierCategory::Parameter, order: 6 },
            Modifier::Params => ModifierInfo { category: ModifierCategory::Parameter, order: 6 },
            
            // Storage modifiers
            Modifier::Fixed => ModifierInfo { category: ModifierCategory::Storage, order: 7 },
        }
    }
    ...
    pub fn is_incompatible_with(&self, other: &Modifier) -> bool {
        match (self, other) {
            ...
            (Modifier::Public, Modifier::Protected) | (Modifier::Protected, Modifier::Public) => true,
            (Modifier::Public, Modifier::Internal) | (Modifier::Internal, Modifier::Public) => true,
            (Modifier::Private, Modifier::Protected) | (Modifier::Protected, Modifier::Private) => true,
            (Modifier::Private, Modifier::Internal) | (Modifier::Internal, Modifier::Private) => true,
            ...
            (Modifier::Abstract, Modifier::Virtual) | (Modifier::Virtual, Modifier::Abstract) => true,
            (Modifier::Abstract, Modifier::Override) | (Modifier::Override, Modifier::Abstract) => true,
            ...
            (Modifier::Virtual, Modifier::Override) | (Modifier::Override, Modifier::Virtual) => true,
    ...
    pub fn get_compatible_modifiers_for(declaration_type: &str) -> Vec<Modifier> {
        match declaration_type {
            ...
            "method" => vec![
                ...
                Modifier::Extern, Modifier::Unsafe, Modifier::New, Modifier::Async, Modifier::Partial,
            ],
            "property" => vec![
                Modifier::Public, Modifier::Private, Modifier::Protected, Modifier::Internal,
                Modifier::Static, Modifier::Abstract, Modifier::Virtual, Modifier::Override,
                Modifier::New, Modifier::Readonly,
            ],
            "field" => vec![
                Modifier::Public, Modifier::Private, Modifier::Protected, Modifier::Internal,
                Modifier::Static, Modifier::Readonly, Modifier::Volatile, Modifier::New, Modifier::Const,
            ],
            "parameter" => vec![
