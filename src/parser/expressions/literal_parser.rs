...
use crate::syntax::nodes::expressions::literal::{Literal, InterpolatedStringLiteral, InterpolatedStringPart};
// use crate::syntax::nodes::expressions::expression::Expression; // Unused
use crate::parser::expressions::expression_parser::parse_expression; // This is used by parse_interpolation
use nom::{
    branch::alt,
    ...
    combinator::{map, map_res, opt, recognize, value, cut /* not, peek */}, // not, peek were unused
        ...
        map(
            delimited(
                ...
                opt(escaped_transform(
                    ...
                    '\\', // Escape character
                    alt(( // Transformation syntax for escaped chars
                        value("\"", nom_char('"')),
                        value("\\", nom_char('\\')),
                        value("\n", nom_char('n')),
                        value("\t", nom_char('t')),
...
fn robust_expression_in_interpolation(input: &str) -> BResult<&str, crate::syntax::nodes::expressions::expression::Expression> {
    context(
...
fn fallback_simple_expression(input: &str) -> BResult<&str, crate::syntax::nodes::expressions::expression::Expression> {
