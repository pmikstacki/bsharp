...
use crate::syntax::nodes::expressions::expression::{Expression, SwitchExpression, SwitchExpressionArm};
...
fn parse_relational_basic_expression(input: &str) -> BResult<&str, Expression> {
    ...
    let (input, rest) = nom::multi::many0(
        tuple((
            bws(alt((
                map(tag(">="), |_| crate::syntax::nodes::expressions::BinaryOperator::GreaterEqual),
                map(tag("<="), |_| crate::syntax::nodes::expressions::BinaryOperator::LessEqual),
                map(tag("=="), |_| crate::syntax::nodes::expressions::BinaryOperator::Equal),
                map(tag("!="), |_| crate::syntax::nodes::expressions::BinaryOperator::NotEqual),
                map(nom_char('>'), |_| crate::syntax::nodes::expressions::BinaryOperator::GreaterThan),
                map(nom_char('<'), |_| crate::syntax::nodes::expressions::BinaryOperator::LessThan),
            ))),
...
fn parse_additive_basic_expression(input: &str) -> BResult<&str, Expression> {
    ...
    let (input, rest) = nom::multi::many0(
        tuple((
            bws(alt((
                map(nom_char('+'), |_| crate::syntax::nodes::expressions::BinaryOperator::Add),
                map(nom_char('-'), |_| crate::syntax::nodes::expressions::BinaryOperator::Subtract),
            ))),
...
fn parse_multiplicative_basic_expression(input: &str) -> BResult<&str, Expression> {
    ...
    let (input, rest) = nom::multi::many0(
        tuple((
            bws(alt((
                map(nom_char('*'), |_| crate::syntax::nodes::expressions::BinaryOperator::Multiply),
                map(nom_char('/'), |_| crate::syntax::nodes::expressions::BinaryOperator::Divide),
                map(nom_char('%'), |_| crate::syntax::nodes::expressions::BinaryOperator::Modulo),
            ))),
