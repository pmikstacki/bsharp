use nom::error::{ContextError, ErrorKind, FromExternalError, ParseError, VerboseError, convert_error};
use std::fmt;
use nom::IResult;
...
// Keep the legacy custom error for backwards compatibility if needed
#[derive(Debug, Clone, PartialEq)]
