use crate::artifacts::symbols::SymbolId;
    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(
            ...
            match self {
                ...
                DependencyType::MethodCall => "Method Call",
                DependencyType::FieldAccess => "Field Access",
                DependencyType::PropertyAccess => "Property Access",
            }
        )
    }
}
