    ...
    pub fn collect_from_compilation_unit(&mut self, unit: &CompilationUnit) {
        ...
        for decl in &unit.declarations {
            match decl {
                ...
                crate::syntax::ast::TopLevelDeclaration::GlobalAttribute(_)
                | crate::syntax::ast::TopLevelDeclaration::FileScopedNamespace(_) => {}
            }
        }
