...
impl SourceMap {
    ...
    pub fn get(&self, id: FileId) -> Option<&(String, String)> { self.files.get(&id) }
}
...
impl Project {
    ...
    pub fn add_single_file(mut self, path: impl Into<String>, source: impl Into<String>, spans: SpanTable) -> (Self, FileId) {
